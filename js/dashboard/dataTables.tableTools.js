...
ZeroClipboard_TableTools.Client.prototype = {
	...
	clipText: '', // text to copiar to clipboard
...
TableTools.BUTTONS = {
	...
	"copy": $.extend( {}, TableTools.buttonBase, {
		...
		"fnComplete": function(nButton, oConfig, flash, text) {
			...
			this.fnInfo( '<h6>Tabla Copiar</h6>'+
				'<p>Copiar '+lines+' registros'+plural+' en portapapeles.</p>',
				1500
			);
		}
	} ),
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Imprimir</h6><p>Utilize la tecla de Crt+'p' para imprimir la tabla. Presione escape para finalizar.</p>",
		"sMessage": null,
		"bShowAll": true,
