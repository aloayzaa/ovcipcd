$(document).ready(function() {
    ...
    // // 	},200);
    // // 	$styleswitcher2.stop().animate({
    // // 		top:$(window).scrollTop()+100
    // // 	},200);
    // // });
    // // Probando
    $(".style-switcher a").click(function(e){
        $('link').last().attr('href', "css/dashboard/"+this.className+".css");
    });
...
//    });
    ...
    //             $(this).find('img').attr("src", "http://172.20.1.50/oficinavirtual/img/dashboard/toggle-subnav-down.png");
    //         } else {
    //             $(this).parent().addClass("active open");
    //             $(this).parent().find('.collapsed-nav').slideDown();
    //             $(this).find('img').attr("src", "http://172.20.1.50/oficinavirtual/img/dashboard/toggle-subnav-up-white.png");
    //         }
    //     });
    // };
    // FIN AGREGADO
...
function verurl(url){
    ...
    $.ajax({
        ...
        error: function (xhr, ajaxOptions, thrownError) {
            // $("#contenido").fadeIn(1000).html('ERROR AL CARGAR');
            msjError();
        // document.getElementById("mensajecarga").style.visibility="hidden";
        }
...
function msjCargando(){
    $('#mensajecarga').html('<div style="display: table-cell;vertical-align: middle;position: relative;"><center><br/><p><img src="http://www.cip-trujillo.org/ovcipcdll/img/dashboard/cargando.gif"/><h2 style="color:black;">Espere un Momento...</h2></p></center></div>');  
