...
class Emitidos_model extends CI_Model {
    ...
    function __construct() {
     ...
     function expedientesQry($usuarioId,$anio){
         $parametros=array($usuarioId,$anio);
...
where exp.nEstadoProveido>=0 and exp.nUsrAdmin=? and year(exp.cExpedienteFechaRegistro)=? and  bPdeEliminado=1 order by exp.cExpedienteFechaRegistro",$parametros);
