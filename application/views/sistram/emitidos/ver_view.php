                          ...
                          echo '<tr style="background-color:#c09853;;">';
                           ...
                           echo '<tr style="background-color: #f2dede;">';
                            ...
                            <td style="text-align: center;">
                                <?php echo $derivado->cAreasDescripcion; ?>
                            </td>
                            <td style="text-align: center;">
            ...
            <br>
             <tr>
                ...
                <td >
                    ...
                    <a class="btn btn-info" target="_blank" href="<?php echo base_url().$multi->cMultimediaLink;?>" ><?php echo $multi->cMultimediaDescripcion?></a><br>
                      <?php } ?>
