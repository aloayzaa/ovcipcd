...
<table border="1" bordercolor="#cacaca">
    <tr>        
        ...
        <td style="padding: 5px 5px 5px 5px; background-color: #d5d5d5; font-weight: bold;">OPCIONES</td>
    </tr>
    <?php 
        $i = 0;
    ...
    <tr>
        ...
        <td style="width: 50px; text-align:center;vertical-align: middle;">
            ...
            <img id="<?php echo $fila->nMcuId; ?>" style="cursor:pointer;" onclick="eliminarMaterial(this)" title="Eliminar" src="<?php echo base_url();?>img/eliminar.png" width="20" height="20"/>
        </td>
    </tr>
    <?php
    }?>
