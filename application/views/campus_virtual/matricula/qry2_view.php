...
$funciones = array(
    ...
    //'Pagos' => 'initEvtUpdPago("matricula/popupPagosMatricula/","Pagos Matricula",700,500)',
...
$Tabla = array('set_columns' => array(array('label' => 'Alumno', 'name' => 'Alumno', 'width' => 200, 'align' => 'left'),
  array('label' => 'Dni', 'name' => 'Dni', 'width' => 50, 'align' => 'left'),
                                      ...
                                      array('label' => 'Opciones', 'name' => 'opcion', 'width' => 100, 'align' => 'left'),
                                     ),
               'sort_name' => 'nMatEstado',
               'caption' => 'Lista de Matriculas',
               'div_name' => 'grid2',
               'source' => 'campus_virtual/matricula/matriculaQry2/'.$parametros['criterio'].'-'.$parametros['hor'],
               'loadOnce' => true,
