<legend>Reporte de Docentes</legend>                                                                                            
<?php
...
$Tabla = array('set_columns' => array(array('label' => 'Horario', 'name' => 'Horario', 'width' => 50, 'align' => 'left'),
               ...
               'sort_name' => 'nHorId',
               'caption' => 'Reporte de Docentes',
               'div_name' => 'grid_docente',
               'source' => 'campus_virtual/reportes1/reportesDQry/'.$parametros['criterio'][0].'_'.$parametros['criterio'][1],
               'loadOnce' => true,
