...
$txt_upd_col_emailp = array('name' => 'txt_upd_col_emailp', 'id' => 'txt_upd_col_emailp', 'value' => mb_convert_encoding($email, "UTF-8"), 'maxlength' => '200', "style" => "resize:none;width:214px;", 'class' => 'cajasemail');
        ...
        <table>
            <tr>
              ...
              <tr>
                    ...
                    <td>
                            <div class="controls">
                                <select id="Distrito" name="Distrito" class="chzn-select" style="width:200px;">
                                    <?php
                                    foreach ($zona as $zona) {
