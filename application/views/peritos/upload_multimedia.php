<script type="text/javascript" src="<?php echo URL_JS; ?>peritos/jsSolicitudUploadMultim.js"></script>
...
$hid_upload_nNotCodigo = array('name' => 'hid_upload_nNotCodigo', 'id' => 'hid_upload_nNotCodigo', 'value' => $nSolId, 'type' => 'hidden');
...
<div style="width: 350px">      
    <div class="control-group">  
        <center><table style="width: 100%;position:relative;margin-left:100px;">
                <tbody>
                    <tr>
                <div  aling="center" class="controls">
                    <h3>
                      Tipo Multimedia:
                    </h3>
