...
<html lang="es">
    <head>
        ...
        <!-- js para alerta de notificaciones/sistram -->
           <script src="<?php echo URL_JS ?>bootbox.js" type="text/javascript"></script> 
        ...
        <script type="text/javascript" src='<?php echo URL_JS_DB; ?>jquery.dataTables.js'></script>
       <script type="text/javascript" src='<?php echo URL_JS_DB; ?>dataTables.tableTools.js'></script>
<link rel="stylesheet" href='<?php echo URL_CSS_DB; ?>dataTables.tableTools.css'>
 ...
 <link rel="stylesheet" href='<?php echo URL_CSS; ?>jquery-ui.css' />
    ...
    <?php
												$valor = $this->session->userdata('nUsuTipo');
                                                    if ($valor == '7') {
												echo anchor('intranet/actualizacion_colegiado', '<img src="' . URL_IMG . 'dashboard/icons/fugue/gear.png" alt=""> Mis Datos');
                                                    } else if ($valor == '2'){}else{
                                                echo anchor('intranet/actualizacion_usuarioexterno', '<img src="' . URL_IMG . 'dashboard/icons/fugue/gear.png" alt=""> Mis Datos');    
                                                    }
                                                    ?>
                            
                    </li>
					                    <li>
							<?php echo anchor('intranet/cambiar_clave', '<img src="' . URL_IMG . 'dashboard/icons/fugue/gear.png" alt=""> Cambiar Clave')?>
