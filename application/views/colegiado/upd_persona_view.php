<script type="text/javascript" src="<?php echo URL_JS; ?>colegiado/jsDatosUsuarioe.js"></script>
<?php
...
$txt_upd_col_direccion = array('name' => 'txt_upd_col_direccion', 'id' => 'txt_upd_col_direccion', 'value' => mb_convert_encoding($direccion, "UTF-8"), "cols" => "190", "rows" => "3", 'style' => "width: 500px; height: 35px;");
...
$txt_upd_col_telefono = array('name' => 'txt_upd_col_telefono', 'id' => 'txt_upd_col_telefono', 'value' => mb_convert_encoding($telefono, "UTF-8"), "style" => "resize:none;width:100px;", 'class' => 'cajasphone');
$txt_upd_col_celular = array('name' => 'txt_upd_col_celular', 'id' => 'txt_upd_col_celular', 'value' => mb_convert_encoding($celular, "UTF-8"), "style" => "resize:none;width:120px;", 'class' => 'cajascell');
$cbosexo = array(
    '' => 'Seleccionar',
    '0' => 'MASCULINO',
    '1' => 'FEMENINO',
);
$txt_ins_col_fecnac = array('name' => 'txt_ins_col_fecnac', 'id' => 'txt_ins_col_fecnac', 'value' => mb_convert_encoding($fecnac, "UTF-8"), 'class' => 'cajascalendar', 'readonly' => true);
$boton = form_submit('btn_upd_colegiado', 'Actualizar Datos Personales', 'id="btn_upd_colegiado" class="btn btn-primary"');
?>

<div id=c_cargar_div class="content">      
    <div class="row-fluid">
        <div class="box">

            <div id=c_cargar_persona class="box-content">
