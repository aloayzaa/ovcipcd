...
<body>
    ...
    <div id="diplomado_izquierda">
        <p id="diplomanombre"><strong><?php echo $certificado['nombre_curso'][$i];?></strong></p>
        ...
        <br>
          ...
          <div id="div_imagen">   
                <center>
                  <img width="90" height="90" src="<?php echo './uploads/certificados/qr/iepi/'.$certificado['qr'][$i].".png" ?>" />
                </center>
          </div>   
    ...
    <div id="diplomado_derecha">
        ...
        <p id="diploma"><strong>CONSTANCIA </strong></p>
           ...
           <p id="contenido">En mérito a su participación como expositor <?php echo $certificado['modulosdictados'][$i]; ?> en el Diplomado <strong><?php echo   $certificado['nombre_curso'][$i];?></strong>, desarrrollado por 
