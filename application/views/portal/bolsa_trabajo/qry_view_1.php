                                    ...
                                    <tbody>
                                        <?php foreach ($bandeja as $bandeja) {//1
                                          ...
                                          <?php  if ($bandeja['nTMultCodigo'] == 2) {
                                              echo " <td style='width: 20px;text-align: center;'><center><a  title='Foto actual' href='../uploads/cip/" . $bandeja["cMultLinkMiniatura"] . "' class='fancybox'><img style='max-width:95%;' src='../uploads/cip/" . $bandeja["cMultLinkMiniatura"] . "' width='80' height='50'></a></center></td>";
                                              } else {
                                              echo " <td style='width: 20px;text-align: center;'><center><a  href='../uploads/files/" . $bandeja["cMultLink"] . "' target='_blank'><img style='max-width:95%;' src='../uploads/cip/" . $bandeja["cMultLinkMiniatura"] . "' width='80' height='50'></a></center></td>";
                                                   } ?>
