...
<body>
    <?php
     ...
     <?php if($i>=1){?>
             ...
             <img style="position:absolute;top:620px;left:430px;" id="firma_dec" src="./uploads/certificados/firma/iepi.png"/>
      <!--<img style="position:absolute;top:593px;left:<?php //echo $cantidad;?>;" id="firma_cap" src="./uploads/certificados/firma/<?php //echo $certificado['firma'][$i];?>"/>-->
          <div id="div_decano" style="position:absolute;top:627px;left:-10px;"> 
           <p id="decano">Ing. MARCO CABRERA HUAMÁN<br>
            Decano</p>
      </div> 
             <div id="div_decano" style="position:absolute;top:627px;left:330px;"> 
                             <p id="docente">Ing. ROGER LEÓN DÍAZ<br>
            Presidente IEPI</p>
      </div>   
      <div id="div_docente" style="position:absolute;top:627px;left:430px;">
          <p id="decano">PhD. Ing. JORGE L. CÁRDENAS GUILLÉN<br>
            Docente</p> 
      </div>
             <div id="div_imagen">   
        <center>
          <img style="position:absolute;top:290px;left:30px;" width="90" height="85" src="<?php echo './uploads/certificados/qr/eventos/'.$certificado['image'][$i].'.png'; ?>" />
        </center>
      </div> 
              <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
     <?php }else{ ?>
           <img style="position:absolute;top:539px;left:120px;" id="firma_dec" src="./uploads/certificados/firma/decano.png"/>
      <img style="position:absolute;top:582px;left:430px;" id="firma_dec" src="./uploads/certificados/firma/iepi.png"/>
     <!-- <img style="position:absolute;top:555px;left:<?php //echo $cantidad;?>;" id="firma_cap" src="./uploads/certificados/firma/<?php //echo $certificado['firma'][$i];?>"/>-->
      ...
      <div id="div_docente" style="position:absolute;top:587px;left:430px;">
            ...
            Docente</p>
             ...
             <div id="div_imagen">   
        <center>
          <img style="position:absolute;top:250px;left:30px;" width="90" height="85" src="<?php echo './uploads/certificados/qr/eventos/'.$certificado['image'][$i].'.png'; ?>" />
        </center>
      </div> 
