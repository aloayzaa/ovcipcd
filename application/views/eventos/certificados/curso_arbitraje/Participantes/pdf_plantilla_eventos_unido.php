     ...
     <p id="certificado" style="line-height:12px;"><strong>CERTIFICADO </strong></p>
          ...
          <?php if(strlen($certificado['nombres'][$i])<=40) {?>
             ...
             <?php if(strlen($certificado['titulo_evento'][$i])<=40 ||  $certificado['horas'][$i]!=0){?>
              <p id="contenido">Por haber aprobado el <strong><?php echo $certificado['titulo_evento'][$i];?></strong>,<br> realizado del 
             15 de Agosto del 2015 al 29 de Enero del 2016,  
             <?php  if ( $certificado['horas'][$i]!=0){?>
                    con una duración de<br> <?php echo  $certificado['horas'][$i]  ?> horas lectivas.
          
             <?php } }          
             
                    else { ?>
                        <p id="contenido1">Por haber aprobado el <strong><?php echo $certificado['titulo_evento'][$i];?></strong>,<br> realizado del 
             15 de Agosto del 2015 al 29 de Enero del 2016,  
             <?php  if ( $certificado['horas'][$i]!=0){?>
                    con una duración de<br> <?php echo  $certificado['horas'][$i]  ?> horas lectivas.
             <?php } }?>
