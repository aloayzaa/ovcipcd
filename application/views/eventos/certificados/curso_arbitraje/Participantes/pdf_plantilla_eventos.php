...
<body><?php
 ...
 if($sub=='Cert'||$sub=='Conf'||$sub=='Capa'||$sub=='Expo'||$sub=='Pone'){
     ...
     <p id="certificado"><strong>CERTIFICADO </strong></p>
        ...
        <p id="contenido">Por haber aprobado el <strong><?php echo $evento;?></strong>,<br> realizado del 
             15 de Agosto del 2015 al 29 de Enero del 2016,  
             <?php  if ($horas!=0){?>
                    con una duración de<br> <?php echo  $horas;  ?> horas lectivas.
                
                    
             <?php } }else { ?>
                      <p id="contenido1">Por haber aprobado el <strong><?php echo $evento; ?></strong>,<br> realizado del 
             15 de Agosto del 2015 al 29 de Enero del 2016,  
             <?php  if ($horas!=0){?>
                    con una duración de<br> <?php echo  $horas;  ?> horas lectivas.
