     ...
     <?php if($i>=1){?>
      ...
      <div id="div_docente" style="position:absolute;top:627px;left:400px;">
          ...
          <center><?php echo $certificado['cargo'][$i]; ?></center>
             ...
             <div id="div_imagen">   
        <center>
          <img style="position:absolute;top:615px;left:432px;" width="100" height="95" src="<?php echo './uploads/certificados/qr/eventos/'.$certificado['image'][$i].'.png'; ?>" />
        </center>
      </div> 
     ...
     <?php }else{ ?>
      ...
      <div id="div_docente" style="position:absolute;top:587px;left:400px;">
          ...
          <center><?php echo $certificado['cargo'][$i]; ?></center>
             ...
             <div id="div_imagen">   
        <center>
          <img style="position:absolute;top:575px;left:432px;" width="100" height="95" src="<?php echo './uploads/certificados/qr/eventos/'.$certificado['image'][$i].'.png'; ?>" />
        </center>
      </div> 
     ...
     <p id="certificado" style="line-height:12px;"><strong>CERTIFICADO </strong></p>
          ...
          <?php if(strlen($certificado['nombres'][$i])<=40) {?>
             ...
             <?php if(strlen($certificado['titulo_evento'][$i])<=40 ||  $certificado['horas'][$i]!=0){?>
              <p id="contenido">Por su participación como Expositor del <strong><?php echo $certificado['titulo_evento'][$i];?></strong>, realizado del 
             15 de Agosto del 2015 al 29 de Enero del 2016,  
             <?php  if ( $certificado['horas'][$i]!=0){?>
                    con una duración de <?php echo  $certificado['horas'][$i]  ?> horas lectivas.
          
             <?php } }          
             
                    else { ?>
                        <p id="contenido1">Por su participación como Expositor del <strong><?php echo $certificado['titulo_evento'][$i];?></strong>, realizado del 
             15 de Agosto del 2015 al 29 de Enero del 2016,  
             <?php  if ( $certificado['horas'][$i]!=0){?>
                    con una duración de <?php echo  $certificado['horas'][$i]  ?> horas lectivas.
             <?php } }?>
        ...
        <p id="fecha">Trujillo, Febrero de 2016.</p>
