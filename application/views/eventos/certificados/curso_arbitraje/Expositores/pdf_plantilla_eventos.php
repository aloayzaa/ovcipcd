...
<body><?php
 ...
 if($sub=='Cert'||$sub=='Conf'||$sub=='Capa'||$sub=='Expo'||$sub=='Pone'){
     ...
     <p id="certificado"><strong>CERTIFICADO </strong></p>
        ...
        <p id="contenido">Por su participación como Expositor del <strong><?php echo  $evento;?></strong>, realizado del 
             15 de Agosto del 2015 al 29 de Enero del 2016,  
             <?php  if ($horas!=0){?>
                    con una duración de <?php echo  $horas;  ?> horas lectivas.
                
                    
             <?php } }else { ?>
                      <p id="contenido1">Por su participación como Expositor del <strong><?php echo  $evento;?></strong>, realizado del 
             15 de Agosto del 2015 al 29 de Enero del 2016,  
             <?php  if ( $horas!=0){?>
                    con una duración de <?php echo  $horas;  ?> horas lectivas.
      ...
      <div id="div_docente" style="position:absolute;top:587px;left:400px;">
       ...
       <div id="div_imagen">   
        <center>
          <img style="position:absolute;top:575px;left:432px;" width="100" height="95" src="<?php echo './uploads/certificados/qr/eventos/'.$image.'.png' ?>" />
        </center>
      </div>   
