 ...
 if($sub=='Cert'||$sub=='Conf'||$sub=='CONF'||$sub=='Capa'||$sub=='Expo'||$sub=='Pone'){
     ...
     <p id="certificado"><strong>CERTIFICADO </strong></p>
      ...
      <div id="div_decano" style="position:absolute;top:587px;left:450px;"> 
       ...
       <div id="div_imagen">   
        <center>
          <img style="position:absolute;top:550px;left:210px;border: black 5px solid;border-radius: 20px;" width="110" height="105" src="<?php echo './uploads/certificados/qr/eventos/'.$image.'.png' ?>" />
        </center>
      </div>   
