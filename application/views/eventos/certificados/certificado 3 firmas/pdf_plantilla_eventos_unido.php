    ...
    <?php
     ...
     <?php if($i>=1){?>
          ...
          <img style="position:absolute;top:593px;left:<?php echo $cantidad;?>;" id="firma_cap" src="./uploads/certificados/firma/<?php echo $certificado['firma'][$i];?>"/>-->
                   <div id="div_decano" style="position:absolute;top:627px;left:-30px;"> 
           <p id="decano">Ing. Luis Mesones Odar<br>
            Decano</p>
      </div> 
             <div id="div_decano" style="position:absolute;top:627px;left:300px;"> 
      ...
      <div id="div_docente" style="position:absolute;top:627px;left:430px;">
            ...
            <?php echo $certificado['cargo'][$i]; ?></p> 
             ...
             <div id="div_imagen">   
        <center>
          <img style="position:absolute;top:230px;left:700px;" width="90" height="85" src="<?php echo './uploads/certificados/qr/eventos/'.$certificado['image'][$i].'.png'; ?>" />
        </center>
      </div> 
     ...
     <p id="certificado" style="line-height:12px;"><strong>CERTIFICADO </strong></p>
          ...
          <?php if(strlen($certificado['nombres'][$i])<=40) {?>
             ...
             <?php  if ( $certificado['horas'][$i]!=0){?>
                    con una duración de <?php echo  $certificado['horas'][$i]  ?> horas académicas, realizado  el  03  y  04 de setiembre.
