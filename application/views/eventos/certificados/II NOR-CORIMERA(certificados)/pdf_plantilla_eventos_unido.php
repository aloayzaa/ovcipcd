...
<body>
    <?php
     ...
     <?php if($i>=1){?>
             <img style="position:absolute;top:577px;left:120px;" id="firma_dec" src="./uploads/certificados/firma/mesones.png"/>
     ...
     <?php }else{ ?>
         <img style="position:absolute;top:545px;left:120px;" id="firma_dec" src="./uploads/certificados/firma/mesones.png"/>
     ...
     <p id="certificado" style="line-height:12px;"><strong>CERTIFICADO </strong></p>
          ...
          <?php if(strlen($certificado['nombres'][$i])<=40) {?>
             ...
             <?php echo  $certificado['tipoevento'][$i]?> del Colegio de Ingenieros del Perú - Consejo Departamental La Libertad,  
             <?php  if ( $certificado['horas'][$i]!=0){?>
                     realizado los días 29, 30 de setiembre y 01 de octubre 2016.
            ...
            <p id="fecha">Trujillo, 01 de octubre, 2016</p>
