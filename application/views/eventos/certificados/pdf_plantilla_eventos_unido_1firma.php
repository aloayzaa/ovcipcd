...
<body>
    <?php
     ...
     <?php if($i>=1){?>
          ...
          <div id="div_decano" style="position:absolute;top:627px;left:450px;"> 
          <p id="decano">Ing. Luis Mesones Odar<br>
            Decano</p></p>
      </div>  
             <div id="div_imagen">   
        <center>
          <img style="position:absolute;top:590px;left:210px;border: black 5px solid;border-radius: 20px;" width="110" height="105" src="<?php echo './uploads/certificados/qr/eventos/'.$certificado['image'][$i].'.png'; ?>" />
        </center>
      </div> 
     ...
     <?php }else{ ?>
         <!-- <img style="position:absolute;top:539px;left:120px;" id="firma_dec" src="./uploads/certificados/firma/decano.png"/>
          <img style="position:absolute;top:555px;left:<?php echo $cantidad;?>;" id="firma_cap" src="./uploads/certificados/firma/<?php echo $certificado['firma'][$i];?>"/>-->
           <div id="div_decano" style="position:absolute;top:587px;left:450px;"> 
          <p id="decano">Ing. Luis Mesones Odar<br>
            Decano</p></p>
      </div>  
             <div id="div_imagen">   
        <center>
          <img style="position:absolute;top:550px;left:210px;border: black 5px solid;border-radius: 20px;" width="110" height="105" src="<?php echo './uploads/certificados/qr/eventos/'.$certificado['image'][$i].'.png'; ?>" />
        </center>
      </div> 
