          ...
          <?php if(strlen($persona)<=40) {?>
            <p id="persona" style="  font-family: 'Arial Black',Gadget,sans-serif;
             ...
             <?php }  ?>
              ...
              <p id="contenido">Por su participación como <strong><?php echo $tipocertificado ?></strong> <?php echo $conjuntor; ?> <strong><?php echo  $evento;?></strong>, organizada por el 
             ...
             <?php } }else { ?>
                  <p id="contenido1">Por su participación como <strong><?php echo $tipocertificado ?></strong> <?php echo $conjuntor; ?> <strong><?php echo  $evento;?></strong>, organizada por el 
                  Capítulo de Ingeniería Mecánica, Eléctrica y Mecatrónica, dentro del marco de celebración de su Semana Capitular.
             <?php  if ($horas!=0){?>
                    <!--con una duración de <?php echo $horas  ?> hora académica.-->
