     ...
     <p id="certificado" style="line-height:12px;"><strong>CERTIFICADO </strong></p>
          ...
          <?php if(strlen($certificado['nombres'][$i])<=40) {?>
             ...
             <?php if(strlen($certificado['titulo_evento'][$i])<=40 ||  $certificado['horas'][$i]!=0){?>
              <p id="contenido">Por su participación como <strong><?php echo  $certificado['tipocertificado'][$i] ?></strong> <?php echo $conjuntor; ?> <strong><?php echo $certificado['titulo_evento'][$i];?></strong>, organizada por el
                Capítulo de Ingeniería Mecánica, Eléctrica y Mecatrónica, dentro del marco de celebración de su Semana Capitular.
             ...
             <?php } }          
                    ...
                    <p id="contenido1">Por su participación como <strong><?php echo  $certificado['tipocertificado'][$i] ?></strong> <?php echo $conjuntor; ?> <strong><?php echo $certificado['titulo_evento'][$i];?></strong>, organizada por el 
                      Capítulo de Ingeniería Mecánica, Eléctrica y Mecatrónica, dentro del marco de celebración de su Semana Capitular.  
             <?php  if ( $certificado['horas'][$i]!=0){?>
                     <!--con una duración de <?php echo  $certificado['horas'][$i]  ?> hora académica.-->
             <?php } }?>
