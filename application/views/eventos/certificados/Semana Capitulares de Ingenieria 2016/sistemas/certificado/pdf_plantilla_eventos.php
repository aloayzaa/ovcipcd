 ...
 if($sub=='Cert'||$sub=='Conf'||$sub=='CONF'||$sub=='Capa'||$sub=='Expo'||$sub=='Pone'){
     ...
     <p id="certificado"><strong>CERTIFICADO </strong></p>
          ...
          <?php if(strlen($persona)<=40) {?>
            <p id="persona" style="  font-family: 'Arial Black',Gadget,sans-serif;
             ...
             <?php }  ?>
              ...
              <p id="contenido">Por su participación como <strong><?php echo $tipocertificado ?></strong> <?php echo $conjuntor; ?> <strong><?php echo  $evento;?></strong>, ofrecida
            en el marco de la Semana del Capítulo de Ingeniería de Sistemas, Computación e Informática del Consejo Departamental de La Libertad,
             <?php  if ($horas!=0){?>
                    con una duración de <?php echo $horas  ?> hora académica.
                
                    
             <?php } }else { ?>
                  <p id="contenido1">Por su participación como <strong><?php echo $tipocertificado ?></strong> <?php echo $conjuntor; ?> <strong><?php echo  $evento;?></strong>, ofrecida 
             en el marco de la Semana del Capítulo de Ingeniería de Sistemas, Computación e Informática del Consejo Departamental de La Libertad,
             <?php  if ($horas!=0){?>
                    con una duración de <?php echo $horas  ?> hora académica.
      ...
      <div id="div_docente" style="position:absolute;top:587px;left:400px;">
       ...
       <div id="div_imagen">   
        <center>
          <img style="position:absolute;top:575px;left:432px;" width="90" height="85" src="<?php echo './uploads/certificados/qr/eventos/'.$image.'.png' ?>" />
        </center>
      </div>   
