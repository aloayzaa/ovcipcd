...
<body>
    <?php
     ...
     <?php if($i>=1){?>
                <img style="position:absolute;top:597px;left:80px;" id="firma_dec" src="./uploads/certificados/firma/vice-decano.png"/>
      <img style="position:absolute;top:593px;left:<?php echo $cantidad;?>;" id="firma_cap" src="./uploads/certificados/firma/<?php echo $certificado['firma'][$i];?>"/>
          ...
          <p id="decano">Ing. CARLOS RODRIGUEZ REYNA<br>
            Vice Decano</p></p>
      </div>  
     ...
     <?php }else{ ?>
           <img style="position:absolute;top:559px;left:80px;" id="firma_dec" src="./uploads/certificados/firma/vice-decano.png"/>
