...
<html lang="es">
    ...
    foreach ($listado as $certificado) { ?> 
        <body>
            ...
            <?php if ($i >= 1) { ?>
                ...
                <div id="div_decano" style="position:absolute;top:890px;left:-0px;"> 
                    <p id="decano">Ing. Luis Mesones Odar<br>
                        Decano</p>
            </div>  
            <div id="div_docente" style="position:absolute;top:890px;left:210px;">
                <p id="docente" >Ing. Neisser Mendoza León</p><br>
              <center>Presidente del Comité Local Chepén-Guadalupe</center>
            </div>
            <div id="div_imagen">   
                <center>
                    <img style="position:absolute;top:880px;left:240px;" width="110" height="105" src="<?php echo './uploads/certificados/qr/eventos/' . $certificado['image'][$i] . '.png'; ?>" />
                </center>
            </div> 
    ...
    <?php } else { ?>
        ...
        <div id="div_imagen">   
            <center>
                <img style="position:absolute;top:830px;left:240px;" width="110" height="105" src="<?php echo './uploads/certificados/qr/eventos/' . $certificado['image'][$i] . '.png'; ?>" />
            </center>
        </div> 
