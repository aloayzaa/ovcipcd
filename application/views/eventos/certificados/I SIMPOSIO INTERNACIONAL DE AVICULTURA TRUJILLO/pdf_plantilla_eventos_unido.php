    ...
    <?php
     ...
     <?php if($i>=1){?>
          ...
          <img style="position:absolute;top:593px;left:<?php echo $cantidad;?>;" id="firma_cap" src="./uploads/certificados/firma/<?php echo $certificado['firma'][$i];?>"/>-->
                   <div id="div_decano" style="position:absolute;top:627px;left:-70px;"> 
           <p id="decano">Ing. Luis Mesones Odar<br>
            Decano CIP-CDLL</p>
      </div> 
             <div id="div_decano" style="position:absolute;top:627px;left:250px;"> 
                     <p id="docente" >Msc. Willman Alarcon Gutierrez</p><br>
               <center>Director Escuela Académico Profesional de Zootecnia - UNT</center>
      </div>   
      <div id="div_docente" style="position:absolute;top:627px;left:430px;">
             <p id="decano">Ing. <?php echo $certificado['presidente'][$i]; ?><br>
            <?php echo $certificado['cargo'][$i]; ?></p> 
      </div> 


             <div id="div_imagen">   
        <center>
          <img style="position:absolute;top:250px;left:760px;" width="100" height="95" src="<?php echo './uploads/certificados/qr/eventos/'.$certificado['image'][$i].'.png'; ?>" />
        </center>
      </div> 
     ...
     <?php }else{ ?>
         <!-- <img style="position:absolute;top:539px;left:120px;" id="firma_dec" src="./uploads/certificados/firma/decano.png"/>
          <img style="position:absolute;top:555px;left:<?php echo $cantidad;?>;" id="firma_cap" src="./uploads/certificados/firma/<?php echo $certificado['firma'][$i];?>"/>-->
                 <div id="div_decano" style="position:absolute;top:587px;left:-70px;"> 
          <p id="decano">Ing. Luis Mesones Odar<br>
            Decano CIP-CDLL</p>
      </div>  
       <div id="div_decano" style="position:absolute;top:587px;left:250px;"> 
                           <p id="docente" >Msc. Willman Alarcon Gutierrez</p><br>
               <center>Director Escuela Académico Profesional de Zootecnia - UNT</center>
      </div>  
     ...
     <p id="certificado" style="line-height:12px;"><strong>CERTIFICADO </strong></p>
          ...
          <?php if(strlen($certificado['nombres'][$i])<=40) {?>
             ...
             <?php  if ( $certificado['horas'][$i]!=0){?>
                    del Colegio de Ingenieros del Perú - CDLL y la Escuela Académico Profesional de Zootecnia de la Universidad Nacional de Trujillo, desarrollado el 13,14 y 15 de octubre del año en curso.
        ...
        <p id="fecha">Trujillo, octubre de 2016</p>
