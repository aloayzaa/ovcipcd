...
<body>
    <div id="diplomado_izquierda">
        <p id="diplomanombre"><strong><?php echo $datos[2]?></strong></p>
       
            <p id="contenido_diplomado"> Contenido </p>
        
        <?php foreach($datos[5]as $modulo){ ?>
        ...
        <br>
          ...
          <div id="div_imagen">   
                <center>
                  <img width="90" height="90" src="<?php echo './uploads/certificados/qr/infocip/'.$datos[7].".png" ?>" />
                </center>
          </div>   
    ...
    <div id="diplomado_derecha">
        ...
        <p id="diploma"><strong>DIPLOMA </strong></p>
           ...
           <p id="contenido">Por haber dictado el <strong><?php echo  $datos[2];?></strong>, desarrrollado en el Centro de Informática 
             <strong>@infoCIP</strong> del Consejo Departamental de La Libertad del <?php echo $datos[3]  ?> al 
           <?php echo $datos[4]  ?>, con una duración de <?php echo $datos[6]  ?> horas.
 ...
 <!--<img style="position:absolute;top:580px;left:718px;" id="firma_dec" src="./uploads/certificados/firma/secretario.png"/>-->
