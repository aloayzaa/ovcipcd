...
<body>
     ...
     <p id="certificado"><strong>CERTIFICADO </strong</p>
          ...
          <?php if(strlen($certificado['nombres'][$i])<=40) {?>
             ...
             <?php }  ?>
              <p id="contenido">Por haber aprobado el <?php echo $certificado['nromodulo'][$i];?>, <strong><?php echo $certificado['nombre_modulo'][$i];?></strong>, del Diplomado en <?php echo $certificado['nombre_curso'][$i];?>, desarrollado en 
             el Centro de Capacitación <strong>@infoCIP</strong> del Consejo Departamental de La Libertad del <?php echo $certificado['fecha_inicio'][$i];  ?> al 
